      ...
      >
        ...
        >
          <Badge
            ...
            variation="default"
            children="New"
            {...getOverrideProps(overrides, "Badgeaeo")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            variation="default"
            children="Classic"
            {...getOverrideProps(overrides, "Badgecwo")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            variation="default"
            children="Modern"
            {...getOverrideProps(overrides, "Badgejhx")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featureeza")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconaiw")}
            >
              <Icon
                width="17.58984375px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorsaw")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featureaxe")}
          >
            <View
              width="24px"
              height="24px"
            ...
            >
              <Icon
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorkhw")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featuredlr")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconhax")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorpyk")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
